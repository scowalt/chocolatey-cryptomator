...
$packageName= 'Cryptomator' # arbitrary name for the package, used in messages
...
$packageArgs = @{
  ...
  softwareName  = 'Cryptomator*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
